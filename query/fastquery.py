...
if __name__ == "__main__":
    ...
    print(query(star, "RA", "simbad"), "RA")
    print(query(star,"DEC", "simbad"), "DEC")
    print(query(star,"PMRA", "simbad"), "PMRA")
    print(query(star,"PMDEC", "simbad"), "PMDEC")
    print(query(star,"med-Lflux", "mdfc"))
    print(query(star,"med-Nflux", "mdfc"))
    print(query(star,"Vmag", "nomad"))
    print(query(star,"Kmag", "wise"))
    print(query(star,"Hmag", "wise"))
